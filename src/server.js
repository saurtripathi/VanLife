...
createServer({
    ...
    routes() {
        ...
        // passthrough is required to allow fetch request to hit other dbs
        // apart from miraje json, in absence of passthrough miraje will 
        // capture all fetch requests and will never let them to hit other dbs.
